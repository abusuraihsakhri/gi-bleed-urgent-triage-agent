"""
FastAPI REST API Server for Gi Bleed Urgent Triage Agent.
"""
...
app = FastAPI(
    title="Gi Bleed Urgent Triage Agent API",
    description="Enterprise Distributed Component Platform (Gastroenterology & Hepatology Systems)",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "gi-bleed-urgent-triage-agent", "domain": "Gastroenterology & Hepatology Systems", "standard": "AASLD / ACG / Chicago Classification v4.0", "version": "3.0.0-ENTERPRISE"}
